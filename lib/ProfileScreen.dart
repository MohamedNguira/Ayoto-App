...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        Container(width: 350, margin: EdgeInsets.fromLTRB(17, 0, 0, 0),
          child:
            ...
            FutureBuilder<String>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (json.length == 0) {
                    return Align(alignment: Alignment.center,child: Text("No medical checks done yet",style:gray),);
                  }
                  ...
                  for (int i = 0; i < json.length; i++) {
                    ...
                    if (!monthsNotEmpty.contains(month)) {
                  ...
                  monthsNotEmpty = monthsNotEmpty.reversed.toList();
...
Future<String> fetchUpcomingAppointments(userId) async {
  ...
  log("fetchUpcomingAppointments in ProfileScreen body: " + body);
  ...
  log("fetchUpcomingAppointments in ProfileScreen response: " + response.body);
  log("fetchUpcomingAppointments in ProfileScreen code: " + response.statusCode.toString());
